...
class SettingsExpandableTitleCheckableItemViewHolder(viewDataBinding: ViewDataBinding) : BaseSettingsViewHolder<ExpandableTitleCheckableItemsData>(viewDataBinding) {

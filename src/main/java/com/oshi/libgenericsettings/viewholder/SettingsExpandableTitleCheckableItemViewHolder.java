...
public class SettingsExpandableTitleCheckableItemViewHolder extends BaseSettingsViewHolder<ExpandableTitleCheckableItemsData> {
    ...
    public SettingsExpandableTitleCheckableItemViewHolder(ViewDataBinding viewDataBinding) {
    ...
    @Override
    public void onBind(final ExpandableTitleCheckableItemsData data, ISettingsPresenter presenter, int position) {

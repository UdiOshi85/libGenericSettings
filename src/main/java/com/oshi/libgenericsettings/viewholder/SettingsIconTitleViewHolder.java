...
public class SettingsIconTitleViewHolder extends BaseSettingsViewHolder<IconTitleData> {

    public SettingsIconTitleViewHolder(ViewDataBinding viewDataBinding) {

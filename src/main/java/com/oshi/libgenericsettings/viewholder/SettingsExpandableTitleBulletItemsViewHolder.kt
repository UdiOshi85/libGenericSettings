...
class SettingsExpandableTitleBulletItemsViewHolder(viewDataBinding: ViewDataBinding) : BaseSettingsViewHolder<ExpandableTitleBulletItemsData>(viewDataBinding) {

 ...
 */
public class SettingsExpandableTitleSimpleItemsViewHolder extends BaseSettingsViewHolder<ExpandableTitleSimpleItemsData> {
    ...
    public SettingsExpandableTitleSimpleItemsViewHolder(ViewDataBinding viewDataBinding) {

...
class SettingsExpandableTitleSimpleItemsViewHolder(viewDataBinding: ViewDataBinding) : BaseSettingsViewHolder<ExpandableTitleSimpleItemsData>(viewDataBinding) {
